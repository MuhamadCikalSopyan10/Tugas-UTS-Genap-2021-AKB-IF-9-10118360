...
public class CostumCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListID.setText(cursor.getString(cursor.getColumnIndex(com.example.uts_10118360.DBHelper.row_id)));
        holder.ListNama.setText(cursor.getString(cursor.getColumnIndex(com.example.uts_10118360.DBHelper.row_nama)));
    }
